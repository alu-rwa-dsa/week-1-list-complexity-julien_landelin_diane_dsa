...
print("The sorted list is:  ", sorted1)
...
sorted50 = sortList(list50)
print("The sorted list is:  ", sorted50)

end50 = time.time()
print(f"Runtime of the program is at length of 1 is {end50 - start50}")
...
sorted100 = sortList(list100)
print("The sorted list is:  ", sorted100)

end100 = time.time()
print(f"Runtime of the program is at length of 1 is {end100 - start100}")

x100 = memory_profiler.memory_usage()

print(x100[-1])

time = [0.06248, 0.04692, 0.04000]
space = [18.30078, 18.34375, 18.3125]
